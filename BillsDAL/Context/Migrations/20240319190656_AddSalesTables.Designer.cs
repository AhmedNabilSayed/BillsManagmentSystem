...
namespace BillsDAL.Migrations
{
    ...
    [Migration("20240319190656_AddSalesTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillsEntity.Customer", b =>
                {
            ...
            modelBuilder.Entity("BillsEntity.SalesBillDetails", b =>
                {
                    b.Property<int>("DTLCOD")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BillsEntity.SalesBillHeader", b =>
                {
                    b.Property<int>("BILCOD")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BillsEntity.SalesBillDetails", b =>
                {
                    b.HasOne("BillsEntity.SalesBillHeader", "BillHeader")
                        .WithMany()
                        .HasForeignKey("BILCOD")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BillsEntity.SalesBillHeader", b =>
                {
                    b.HasOne("BillsEntity.Customer", "Customer")
                        .WithMany()
