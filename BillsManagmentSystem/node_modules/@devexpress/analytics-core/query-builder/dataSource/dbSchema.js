...
export class DBSchema {
    constructor(model) {
        var tables = deserializeToCollection(model['Tables'], (tableModel) => new DBTable(tableModel));
        tables.sort((a, b) => { return a.name.localeCompare(b.name); });
        var views = deserializeToCollection(model['Views'], (tableModel) => new DBTable(tableModel));
