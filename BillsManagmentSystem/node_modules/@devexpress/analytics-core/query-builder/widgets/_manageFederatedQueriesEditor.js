...
export class ManageFederatedQueriesEditor extends PopupEditorBase {
    ...
    _createAddQueryButton() {
        ...
        var queriesTreeNode = new FederatedQueriesTreeNode('queries', getLocalization('Federated Queries', 'DataAccessUIStringId.FederatedQueryCollectionList_Title'), 'list', false, ko.observable({ showQbCallBacks: this._queriesPopupHelper.callBacks }));
    ...
    save() {
        this.queriesStoreData().forEach(data => {
            var query = findFirstItemMatchesCondition(this._dataSource.queries(), query => query.alias() === data.id);
