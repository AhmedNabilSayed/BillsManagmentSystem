...
export class ColumnViewModel extends QueryElementBaseViewModel {
    constructor(model, dbColumn, parent, serializer) {
        ...
        var targetColumn = ko.pureComputed(() => ColumnExpressionCollectionHelper.find(query.columns, parent.actualName(), this.name()));
        ...
        var orderByItem = ko.pureComputed(() => ColumnExpressionCollectionHelper.find(query.sorting, parent.actualName(), this.name()));
        ...
        var groupByItem = ko.computed(() => ColumnExpressionCollectionHelper.find(query.grouping, parent.actualName(), this.name()));
