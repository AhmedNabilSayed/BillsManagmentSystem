...
export var federationQuerySerializationsInfo = [
...
export class FederationQueryViewModel extends QueryViewModelBase {
    ...
    serialize(includeRootTag) {
        var serializer = this.serializer || new ModelSerializer();
        ...
        this.subNodes(_tables.map(table => {
            var relation = findFirstItemMatchesCondition(_relations, relation => relation.nestedTable() === table);
            if (!relation)
