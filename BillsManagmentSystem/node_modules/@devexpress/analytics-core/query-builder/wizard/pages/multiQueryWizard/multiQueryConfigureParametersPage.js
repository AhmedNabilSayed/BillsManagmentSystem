...
export class MultiQueryConfigureParametersPage extends WizardPageBase {
            ...
            itemsProvider: {
                getItems: pathRequest => {
                    ...
                    if (!pathRequest.fullPath) {
                        ...
                        var parent = findFirstItemMatchesCondition(this._rootItems(), item => item.name === pathRequest.ref);
    ...
    commit() {
        this._rootItems().forEach(item => {
            var customQuery = findFirstItemMatchesCondition(this._sqlDataSourceWrapper.customQueries, (query) => query.name() === item.query().name());
