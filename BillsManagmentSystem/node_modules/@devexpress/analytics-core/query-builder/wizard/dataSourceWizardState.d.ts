...
export declare var _setRestoreSqlDataSourceFromState: (func: (state?: ISqlDataSourceWizardState, requestWrapper?: RequestWrapper, dataSourceId?: string) => _SqlDataSourceWrapper) => void;
export declare var _resetRestoreSqlDataSourceFromState: () => void;
export declare var _restoreFederationDataSourceFromState: (state: IFederationDataSourceWizardState, usedDataSources: ko.ObservableArray<IDataSourceInfo> | ko.Computed<IDataSourceInfo[]>, dataSourceId?: string) => FederationDataSource;
