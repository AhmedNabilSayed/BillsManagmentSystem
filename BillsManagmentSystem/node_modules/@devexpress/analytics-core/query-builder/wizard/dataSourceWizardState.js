...
export var _restoreSqlDataSourceFromState = _defaultRestoreSqlDataSourceFromState;
export var _setRestoreSqlDataSourceFromState = (func) => { _restoreSqlDataSourceFromState = func; };
export var _resetRestoreSqlDataSourceFromState = () => { _restoreSqlDataSourceFromState = _defaultRestoreSqlDataSourceFromState; };
var _defaultRestoreFederationDataSourceFromState = (state, usedDataSources, dataSourceId) => {
    var dataSource = new FederationDataSource(JSON.parse(state.federationDataSourceJSON), usedDataSources);
    if (dataSourceId) {
...
export var _restoreFederationDataSourceFromState = _defaultRestoreFederationDataSourceFromState;
...
export var _restoreJsonDataSourceFromState = _defaultRestoreJsonDataSourceFromState;
