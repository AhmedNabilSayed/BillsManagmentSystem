    ...
    _createTreePart(pathParts, deferred = $.Deferred(), checkedPath) {
        ...
        if (!checkedPath) {
            ...
            if (pathParts.length === 1) {
                this.getItems(new PathRequest(pathParts[0], pathParts)).done(() => _deferred.resolve()).fail(() => _deferred.reject());
            }
            else
            ...
            var request = new PathRequest(newParentPath.join('.'), newParentPath);
