...
export class FederationTransformQueryBuilderPopup extends FederationQueryBuilderPopupBase {
    constructor(onSaveCallback, dataSource, rtl = false, onCloseCallback) {
        ...
        var transformResultSchemaProvider = new TransformResultSchemaProvider(this._dataSource.dbSchemaProvider, this.transformSources, this.currentPath);
    ...
    _aliasValidationCallback(alias, data) {
        var existedColumn = findFirstItemMatchesCondition(this.transformSources(), source => source.alias === alias);
