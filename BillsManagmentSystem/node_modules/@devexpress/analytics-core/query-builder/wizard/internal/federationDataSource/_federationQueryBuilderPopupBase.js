...
export class FederationQueryBuilderPopupBase extends PopupEditorBase {
    constructor(onSaveCallback, _dataSource, rtl = false, onCloseCallback) {
        ...
        var treeListController = new FederatedUnionQueryBuilderTreeListController(this.dragDropHandler, (item) => treeListController.isDraggable(item) && this.addDataMember(item));
        this.fieldListModel = {
