...
import { createPasswordSerializationInfo } from '../../../core/utils/_utils';
...
export class JsonDataSourceJsonSourcePageUriSettings extends JsonDataSourceJsonSourcePageSettingsBase {
    ...
    _validateUriSource() {
        var defaultValidationErrorMessage = getLocalization('Invalid URI.', 'AnalyticsCoreStringId.ReportDesigner_Wizard_JsonSource_UriValidationError');
        var endpointUriDisplayName = getLocalization('Web Service Endpoint (URI):', 'DataAccessUIStringId.WizardPageChooseJsonSource_URI');
    ...
    _getParametersInfo() {
        var parameters = {
            ...
            array: true,
            addHandler: () => {
                var newName = getUniqueNameForNamedObjectsArray(this.parameters(), 'parameter');
                return JsonParameter.from({ '@Name': newName });
            },
        ...
        parameters.editorOptions = {
            ...
            nameValidationRules: [{
                    type: 'required',
                    get message() {
                        return getLocalizedValidationErrorMessage(null, getLocalization(parameters.displayName, parameters.localizationId), this._collectionItemNamePlaceholder);
                    }
                }]
        };
        return parameters;
