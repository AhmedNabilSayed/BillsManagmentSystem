...
QueryBuilderPopupBase.customizeQueryBuilderActions = (sender, args) => {
    ...
    var del = findFirstItemMatchesCondition(actions, action => action.text === 'Delete'), undo = findFirstItemMatchesCondition(actions, action => action.text === 'Undo'), redo = findFirstItemMatchesCondition(actions, action => action.text === 'Redo');
