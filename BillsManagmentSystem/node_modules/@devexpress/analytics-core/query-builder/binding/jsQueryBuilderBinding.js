...
import { _wrapModelInObservable } from '../../core/utils/_utils';
...
export class JSQueryBuilderBinding extends JSDesignerBindingCommon {
    ...
    _initializeCallbacks() {
        if (this._options.callbacks) {
            var queryBuilderEvents = EventGenerator.generateQueryBuilderEvents((eventName, args) => {
...
ko.bindingHandlers['dxQueryBuilderSurface'] = {
    init: function (element, valueAccessor) {
        ...
        var templateHtml = getTemplate('dxrd-querybuilder'), $element = $.fn.constructor(element).append(templateHtml);
