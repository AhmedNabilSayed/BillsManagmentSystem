...
export function createDiagramDesigner(element, diagramSource, localization, rtl) {
    ...
    registerControls();
    var diagram = ko.pureComputed(() => { return new DiagramViewModel(diagramSource()); }), surface = ko.pureComputed(() => {
        var surface = new DiagramSurface(diagram());
        return surface;
    });
    var designerModel = createDesigner(diagram, surface, diagramControlsFactory, groups, undefined, undefined, rtl);
    ...
    var updateSurfaceContentSize_ = updateSurfaceContentSize(designerModel.surfaceSize, element);
    var onResize = () => {
