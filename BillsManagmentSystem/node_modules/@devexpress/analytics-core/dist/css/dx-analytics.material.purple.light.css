...
.dx-designer .dx-designer-viewport .dxrd-fieldslist-wrapper #btn-add-dataSource .dx-button-content {
  padding: 4px;
}
.dx-designer .dx-designer-viewport .dxrd-fieldslist-wrapper #btn-add-dataSource .dx-button-content .dx-icon-dxrd {
  width: auto;
  height: auto;
  display: inline-flex;
...
.dx-designer .dx-designer-viewport .dxrd-fieldslist-wrapper #btn-add-dataSource .dx-button-content .dx-button-text {
  font-size: 11px;
}
