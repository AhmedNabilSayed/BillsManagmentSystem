...
declare module DevExpress.Analytics.Internal {
	...
	export function getPaperSize(kind: string, precision?: number): {
	    width: number;
	    height: number;
	};
	...
	export function unitsToPixel(val: number, measureUnit: MeasureUnit, zoom?: number): number;
	export function pixelToUnits(val: number, measureUnit: MeasureUnit, zoom: number): number;
	export interface IUnitProperties<M> {
	    [key: string]: (o: M) => ko.Observable<number> | ko.Computed<number>;
	}
	export function createUnitProperty<M>(model: M, target: object, propertyName: string, property: (o: M) => ko.Observable<number> | ko.Computed<number>, measureUnit: ko.Observable<MeasureUnit> | ko.Computed<MeasureUnit>, zoom: ko.Observable<number> | ko.Computed<number>, afterCreation?: (property: any) => void): void;
	export function createUnitProperties<M>(model: M, target: object, properties: IUnitProperties<M>, measureUnit: ko.Observable<MeasureUnit> | ko.Computed<MeasureUnit>, zoom: ko.Observable<number> | ko.Computed<number>, afterCreation?: (property: any) => void): void;
	...
	export function deleteSelection(selection: ISelectionProvider, selectedObject?: any): void;
...
declare module DevExpress.Analytics.Widgets.Internal {
	...
	export interface ICollectionEditorOptions {
	    ...
	    addHandler: () => any;
	    removeHandler?: (parameter: any) => any;
	    displayName?: string;
...
declare module DevExpress.QueryBuilder.Internal {
	...
	export function wrapRebuildResultSchema(callback?: (dataSource: SqlDataSource, queryName?: string, relationsEditing?: boolean) => JQueryPromise<IRebuildSchemaResponse>): (dataSource: SqlDataSource, queryName?: string, relationsEditing?: boolean) => JQueryPromise<IRebuildSchemaResponse>;
...
declare module DevExpress.Analytics.Wizard {
	...
	export function _registerConfigureMasterDetailRelationshipsPage(factory: PageFactory, sqlDataSourceResultSchema: (dataSource: SqlDataSource, queryName?: string, relationsEditing?: boolean) => JQueryPromise<IRebuildSchemaResponse>): void;

	export var AutoQueryPreload: (newVal?: boolean) => boolean;
