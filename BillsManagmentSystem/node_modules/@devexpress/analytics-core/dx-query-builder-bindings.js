...
addToBindingsCache('event: { dblclick: $root.inlineTextEdit.show }, style: { cursor: selected() ? \'move\' : \'default\' }', function ($context, $element) { return { 'event': function () { return { 'dblclick': $context.$root.inlineTextEdit.show }; }, 'style': function () { return { 'cursor': $context.$data.selected() ? 'move' : 'default' }; } }; });
...
addToBindingsCache('text: $root.getLocalization($parent.name), attr: { title: $root.getLocalization($parent.name) }', function ($context, $element) { return { 'text': function () { return $context.$root.getLocalization($context.$parent.name); }, 'attr': function () { return { 'title': $context.$root.getLocalization($context.$parent.name) }; } }; });
addToBindingsCache('dxPropertyGrid: { target: value, level: 1, parentDisabled: editor.disabled }', function ($context, $element) { return { 'dxPropertyGrid': function () { return { 'target': $context.$data.value, 'level': 1, 'parentDisabled': $context.$data.editor.disabled }; } }; });
...
addToBindingsCache('dxTextBox: { value: queryName }', function ($context, $element) { return { 'dxTextBox': function () { return { 'value': $context.$data.queryName }; } }; });
...
addToBindingsCache('ifnot: $data.hasItems', function ($context, $element) { return { 'ifnot': function () { return $context.$data.hasItems; } }; });
addToBindingsCache('if: $data.showIcon', function ($context, $element) { return { 'if': function () { return $context.$data.showIcon; } }; });
addToBindingsCache('ifnot: $data.showIcon', function ($context, $element) { return { 'ifnot': function () { return $context.$data.showIcon; } }; });
...
addToBindingsCache('styleunit: { \'marginLeft\' : editor.padding }, css: { \'dxrd-group-header-collapsed\': collapsed() }', function ($context, $element) { return { 'styleunit': function () { return { 'marginLeft': $context.$data.editor.padding }; }, 'css': function () { return { 'dxrd-group-header-collapsed': $context.$data.collapsed() }; } }; });
...
addToBindingsCache('dxclick: $parents[1].select, css: { \'dxd-state-selected dxd-back-secondary\' : $parents[1].selectedIndex() === $index() }', function ($context, $element) { return { 'dxclick': function () { return $context.$parents[1].select; }, 'css': function () { return { 'dxd-state-selected dxd-back-secondary': $context.$parents[1].selectedIndex() === $context.$index() }; } }; });
addToBindingsCache('visible: showButtons', function ($context, $element) { return { 'visible': function () { return $context.$data.showButtons; } }; });
addToBindingsCache('dxButton: { onClick: add, text: getDisplayTextButton(\'add\') }, attr: { title: getDisplayTextButton(\'add\') }', function ($context, $element) { return { 'dxButton': function () { return { 'onClick': $context.$data.add, 'text': $context.$data.getDisplayTextButton('add') }; }, 'attr': function () { return { 'title': $context.$data.getDisplayTextButton('add') }; } }; });
