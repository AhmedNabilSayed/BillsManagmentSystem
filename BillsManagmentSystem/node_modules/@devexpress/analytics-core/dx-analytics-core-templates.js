...
SvgTemplatesEngine.addTemplates({
    ...
    'dx-combobox-editable': '<div data-bind="dxLocalizedSelectBox: { items: values, value: value, valueExpr: \'value\', displayExpr: \'displayValue\', disabled: disabled, acceptCustomValue: true, onCustomItemCreating: function(arg) { return { value: arg.text, displayValue: arg.text }; }, dropDownOptions: { container: $root.getPopupContainer($element) }, popupPosition: { boundary: $root.getPopupContainer($element) }, inputAttr: { \'aria-label\': displayName }, useLocalizedTextAsValue: true }">   </div>',
