...
ko.bindingHandlers['dxTextAlignmentEditor'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        var templateHtml = getTemplate('dxrd-textalignment-editor'), $element = $.fn.constructor(element).append(templateHtml);
        var model = new TextAlignmentModel(valueAccessor());
