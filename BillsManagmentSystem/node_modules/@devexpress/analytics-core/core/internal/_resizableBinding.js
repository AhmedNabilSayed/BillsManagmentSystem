...
import { getResizeDirection, Resizable } from './_resizable';
ko.bindingHandlers['resizable'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        var values = valueAccessor();
        var $element = $.fn.constructor(element), $parent = $element.closest('.dx-designer'), currentDirection = null, $selectedNodes = null, resizableDirections = { 'north': 'n', 'east': 'e', 'south': 's', 'west': 'w' }, calculateSizes = [], absolutePosition = null;
        var options = extend({
            handles: ko.isSubscribable(values.handles) ? values.handles : (values.handles || 'all'),
            ghost: false,
            stop: function (event) {
                $selectedNodes.each((_, el) => {
                    var context = ko.contextFor(el), control = context.$data, surface = context.$root.surface(), $el = $.fn.constructor(el);
        ...
        var resizableElement = new Resizable(element, options).initialize();
