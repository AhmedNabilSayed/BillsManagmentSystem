...
function doesPaneExist(panes, paneName) {
    return panes.some(pane => pane.name === paneName)
}
...
function applyAutoHidePointMarkers(allSeries, filteredSeries, overloadedSeries, argAxis) {
    ...
    filteredSeries.forEach(s => {
        ...
        if (s.autoHidePointMarkersEnabled() && (argAxisType === DISCRETE || overloadedSeries[seriesIndex].pointsCount > tickCount)) {
            ...
            Object.keys(overloadedSeries[seriesIndex]).forEach(index => {
                var i = parseInt(index, 10);
                if (shouldContinueLoop && (isNaN(i) || overloadedSeries[seriesIndex].total / overloadedSeries[seriesIndex].continuousSeries < 3)) {
                    return
                }
                if (i === seriesIndex) {
