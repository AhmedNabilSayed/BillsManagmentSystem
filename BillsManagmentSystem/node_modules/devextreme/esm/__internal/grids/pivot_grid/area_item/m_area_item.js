...
var AreaItem = Class.inherit({
    ...
    _renderTableContent(tableElement, data) {
        ...
        for (i = 0; i < rowsCount; i += 1) {
            ...
            for (j = 0; j < row.length; j += 1) {
                ...
                if (cell) {
                    cell.rowspan && columnMarkupArray.push("".concat("rowspan='" + (cell.rowspan || 1), "'"));
                    cell.colspan && columnMarkupArray.push("".concat("colspan='" + (cell.colspan || 1), "'"));
                    var styleOptions = {
                        cellElement: void 0,
                        cell: cell,
                    ...
                    if (isDefined(cell.expanded)) {
                        columnMarkupArray.push("<div class='dx-expand-icon-container'><span class='".concat(PIVOTGRID_EXPAND_CLASS, "'></span></div>"))
                    }
                ...
                columnMarkupArray.push(">".concat(cellText, "</span>"));
                if (cell.sorted) {
    ...
    setColumnsWidth(values) {
        ...
        for (i = 0; i < columnsCount; i += 1) {
            colgroupElementHTML += '<col style="width: '.concat(columnWidth[i], 'px">')
        }
