...
var TextEditorBase = _editor.default.inherit({
    ...
    _setLabelContainerAria: function(force) {
        var label = this._label.getId() || void 0;
        if (label || force) {
            this.setAria("labelledby", label, this._getLabelContainer())
        }
    },
    _renderLabel: function() {
        ...
        var labelConfig = {
            ...
            getContainerWidth: function() {
                return _this2._getLabelContainerWidth()
            },
            getBeforeWidth: function() {
                return _this2._getLabelBeforeWidth()
            }
        };
