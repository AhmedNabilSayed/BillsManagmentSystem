...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto.renderRWorkSpace = function() {
        var _ref4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : DEFAULT_WORKSPACE_RENDER_OPTIONS.renderComponents,
            header = _ref4.header,
            timePanel = _ref4.timePanel,
            dateTable = _ref4.dateTable,
            allDayPanel = _ref4.allDayPanel;
        if (header) {
    ...
    _proto.renderWorkSpace = function() {
        var _ref5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : DEFAULT_WORKSPACE_RENDER_OPTIONS,
            generateNewData = _ref5.generateNewData,
            renderComponents = _ref5.renderComponents;
        this.cache.clear();
