            ...
            if (!_this4._isMasterDetailCell($cell) || _this4._isRowEditMode()) {
                ...
                if ((0, _m_keyboard_navigation_utils.isElementDefined)($cell)) {
                    if ($cell.is("td") || $cell.hasClass(_this4.addWidgetPrefix(_const2.EDIT_FORM_ITEM_CLASS))) {
                        ...
                        var column = _this4._getColumnByCellElement($cell);
    ...
    _proto._editingCellHandler = function(eventArgs, editorValue) {
        ...
        if (!keyDownEvent.isDefaultPrevented()) {
            ...
            if (!keyPressEvent.isDefaultPrevented()) {
                ...
                setTimeout((function() {
                    var inputValue = _this6._getKeyPressInputValue($input, editorValue);
        ...
        views: {
            rowsView: {
                ...
                _renderFocusByChange: function(change) {
                    ...
                    var hasInsertsOrRemoves = !!(null === (_a = null === change || void 0 === change ? void 0 : change.changeTypes) || void 0 === _a ? void 0 : _a.find((function(changeType) {
                        return "insert" === changeType || "remove" === changeType
                    })));
            ...
            editing: {
                ...
                _processCanceledEditingCell: function() {
                    ...
                    this.closeEditCell().done((function() {
                        var keyboardNavigation = _this7.getController("keyboardNavigation");
