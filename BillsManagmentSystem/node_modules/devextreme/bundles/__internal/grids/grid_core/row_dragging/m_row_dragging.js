...
var RowDraggingExtender = {
    ...
    _updateSortable: function() {
        ...
        [this._sortable, this._sortableFixed].forEach((function(sortable) {
            ...
            if ((0, _type.isDefined)(toIndex) && (0, _type.isDefined)(_this3._previousOffset)) {
    ...
    _getDraggableRowTemplate: function() {
        ...
        return function(options) {
            var $rootElement = _this4.component.$element();
            var $dataGridContainer = (0, _renderer.default)("<div>");
            (0, _size.setWidth)($dataGridContainer, (0, _size.getWidth)($rootElement));
            var items = _this4._dataController.items();
            var row = items && items[options.fromIndex];
            var gridOptions = _this4._getDraggableGridOptions(row);
            _this4._createComponent($dataGridContainer, _this4.component.NAME, gridOptions);
            $dataGridContainer.find(".dx-gridbase-container").children(":not(.".concat(_this4.addWidgetPrefix(_const.CLASSES.rowsView), ")")).hide();
    ...
    _getHandleTemplate: function() {
        ...
        return _dom.GridCoreRowDraggingDom.createHandleTemplateFunc((function(string) {
            return _this5.addWidgetPrefix(string)
        }))
    },
