...
var getEmptyComponent = function() {
    var emptyComponentConfig = {
        ...
        ctor: function(element, options) {
            ...
            var width = options && (0, _type.isNumeric)(options.width) ? "".concat(options.width, "px") : "100%";
            var height = options && (0, _type.isNumeric)(options.height) ? "".concat(options.height, "px") : "".concat(this._getDefaultSize().height, "px");
...
var baseWidget = isServerSide ? getEmptyComponent() : _dom_component.default.inherit({
    ...
    _initEventTrigger: function() {
        ...
        this._eventTrigger = (0, _base_widget.createEventTrigger)(this._eventsMap, (function(name, actionSettings) {
            return _this5._createActionByOption(name, actionSettings)
        }))
    },
    _calculateRawCanvas: function() {
        ...
        var getSizeOfSide = function(size, side, getter) {
            ...
            var elementSize = getter(_this6._$element);
    ...
    _setupResizeHandler: function() {
        ...
        this._disposeResizeHandler = (0, _base_widget.createResizeHandler)(this._$element[0], redrawOnResize, (function() {
            return _this7._requestChange(["CONTAINER_SIZE"])
        }))
    },
    ...
    _getActionForUpdating: function(args) {
        var _this8 = this;
        return function() {
            baseOptionMethod.apply(_this8, args)
        }
    },
    _clean: _common.noop,
    ...
    _optionChanged: function(arg) {
        ...
        if (partialChanges.length > 0) {
            partialChanges.forEach((function(pc) {
                return changes.push(_this9._partialOptionChangesMap[pc])
            }))
        } else {
                ...
                if (1 === sections.length) {
                    if ("object" === (0, _type.type)(value)) {
                        ...
                        if (value.length > 0 && value.every((function(item) {
                                return _this10._checkOptionsForPartialUpdate(item, options)
                            }))) {
                            value.forEach((function(item) {
                                _this10._addOptionsNameForPartialUpdate(item, options, partialChangeOptionsName)
                            }))
                        }
                    }
                }
