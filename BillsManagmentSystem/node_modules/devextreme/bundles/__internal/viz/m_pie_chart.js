...
var dxPieChart = _m_base_chart.BaseChart.inherit({
    ...
    _renderCenterTemplate: function() {
        ...
        template.render({
            ...
            onRendered: function() {
                ...
                group.move(_this2._center.x - (bBox.x + bBox.width / 2), _this2._center.y - (bBox.y + bBox.height / 2));
                group.attr({
                    visibility: "visible"
                })
            }
    ...
    _getLegendCallBack: function() {
        ...
        return function(target) {
            items.forEach((function(data) {
                ...
                _this3.series.forEach((function(series) {
    ...
    _resolveLabelOverlappingShift: function() {
        ...
        labelsOverlapped = seriesByPosition.columns.reduce((function(r, singleSeries) {
            return resolveOverlappedLabels(dividePoints(singleSeries), shiftInColumnFunction, inverseDirection, _this4._canvas) || r
        }), labelsOverlapped);
        if (seriesByPosition.outside.length > 0) {
            labelsOverlapped = resolveOverlappedLabels(seriesByPosition.outside.reduce((function(r, singleSeries) {
                ...
                return (0, _utils.getVerticallyShiftedAngularCoords)(box, -length, _this4._center)
