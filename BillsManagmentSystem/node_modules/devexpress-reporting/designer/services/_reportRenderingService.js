...
export class ReportRenderingService {
    ...
    static getUnknownControlImage(model, scale) {
        return ajax(HandlerUri(), 'renderUnknownControl', encodeURIComponent(JSON.stringify({
    ...
    static getShapeImage(surface) {
        ...
        return ajax(HandlerUri(), 'shapeGlyph', encodeURIComponent(JSON.stringify(params)));
    }
    static getRichImage(surface, propertyName) {
        return ajax(HandlerUri(), 'renderRich', encodeURIComponent(JSON.stringify({
    ...
    static getPdfContentData(control) {
        return ajax(HandlerUri(), 'renderPdfContent', encodeURIComponent(JSON.stringify({
