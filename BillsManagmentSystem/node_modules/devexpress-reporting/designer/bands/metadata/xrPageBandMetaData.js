...
export var pageBandSerializationInfoPageHeader = [printOn, commonBandScripts].concat(bandSerializationInfo);
export var pageBandSerializationInfo = [printOn, commonBandScripts].concat(bandSerializationInfo);
export var popularPropertiesPageHeader = ['printOn', printAcrossBands.propertyName];
export var popularPropertiesPageFooter = ['printOn'];
