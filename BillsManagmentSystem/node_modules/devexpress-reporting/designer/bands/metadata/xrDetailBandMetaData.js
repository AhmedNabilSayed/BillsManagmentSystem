...
export var hierarchyPrintOptions = {
...
export var fillEmptySpace = { propertyName: 'fillEmptySpace', modelName: '@FillEmptySpace', defaultVal: false, from: parseBool, displayName: 'Fill Empty Space', localizationId: 'DevExpress.XtraReports.UI.DetailBand.FillEmptySpace', editor: editorTemplates.getEditor('bool') };
export var generalBandSerializationInfo = [
    evenStyleName, oddStyleName,
    keepTogetherDefaultValueFalse,
    pageBreak, commonBandScripts
].concat(bandSerializationInfo);
export var subBandSerializationInfo = [
    level
].concat(generalBandSerializationInfo);
export var generalBandPopularProperties = ['pageBreak', 'keepTogether', printAcrossBands.propertyName];
export var detailBandSerializationInfo = generalBandSerializationInfo.concat(drillDownDetailReportExpanded, hierarchyPrintOptions, drillDownControl, keepTogetherWithDetailReports, fillEmptySpace, sortFields, multiColumn);
export var popularPropertiesDetail = generalBandPopularProperties.concat('sortFields', 'keepTogetherWithDetailReports', fillEmptySpace.propertyName, 'multiColumn');
