...
export var expanded = { propertyName: 'expanded', modelName: '@Expanded', from: parseBool, defaultVal: true };
export var commonBandSerializationInfo = [
...
export var bandSerializationInfo = [
    styleName, stylesObj, stylePriority, height, printAcrossBands
].concat(commonBandSerializationInfo);
export var reportHeaderBandSerializationInfo = [keepTogetherDefaultValueFalse, pageBreak, commonBandScripts].concat(bandSerializationInfo);
export var reportFooterBandSerializationInfo = [printAtBottom].concat(reportHeaderBandSerializationInfo);
export var popularPropertiesReportHeader = [pageBreak.propertyName, 'keepTogether'];
export var popularPropertiesReportFooter = [pageBreak.propertyName, 'keepTogether', 'printAtBottom'];
