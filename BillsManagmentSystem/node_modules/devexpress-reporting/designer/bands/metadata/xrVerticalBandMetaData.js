...
var width = { propertyName: 'width', modelName: '@WidthF', defaultVal: 300, editor: editorTemplates.getEditor('numeric'), displayName: 'Width', localizationId: 'DevExpress.XtraReports.UI.XRControl.Width', from: floatFromModel, localizable: true };
export var commonVerticalBandProperties = [width, keepTogetherDefaultValueFalse].concat(bandSerializationInfo);
export var bandLayout = {
...
export var verticalHeaderBandSerializationInfo = [repeatEveryPage].concat(commonVerticalBandProperties);
export var popularPropertiesVerticalHeaderBand = ['repeatEveryPage'];
export var verticalTotalBandSerializationInfo = [].concat(commonVerticalBandProperties);
export var popularPropertiesVerticalTotalBand = [];
