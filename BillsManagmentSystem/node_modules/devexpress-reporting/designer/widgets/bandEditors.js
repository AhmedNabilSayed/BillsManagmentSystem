...
export class SortingBandEditor extends BandEditorBase {
    constructor(info, level, parentDisabled, textToSearch) {
        ...
        this.noneNeaded = true;
        var value = ko.computed(() => { return this.value() || {}; });
        this._disposables.push(value);
        this.viewmodel = new ObjectProperties(value, { editors: [sortFields, groupFields] }, level + 1, this.disabled, textToSearch);
...
export class PageBreakBandEditor extends Editor {
    constructor(info, level, parentDisabled, textToSearch) {
        ...
        this._disposables.push(this.values = ko.pureComputed(() => {
            if (this._model() && this._model()[printAcrossBands.propertyName] && !!this._model()[printAcrossBands.propertyName]())
