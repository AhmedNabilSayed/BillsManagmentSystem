...
*/
import { insertInFunctionDisplay } from '@devexpress/analytics-core/analytics-widgets-internal';
export var reportFunctionDisplay = ((addins) => insertInFunctionDisplay(addins))([{
        display: 'String',
        items: {
