...
export class StylesEditorHeaderModel {
    constructor(styleName, styles, disabled, popupContainer) {
        ...
        this.items = ko.pureComputed(() => {
            var result = [new StyleModel({ '@Name': getLocalization(StylesEditorHeaderModel.newItem, StylesEditorHeaderModel.newItemTextId) })];
            if (styles && styles()) {
        ...
        this.onValueChanged = (e) => {
            if (e.value === getLocalization(StylesEditorHeaderModel.newItem, StylesEditorHeaderModel.newItemTextId)) {
                var newStyleName = getUniqueNameForNamedObjectsArray(styles(), 'xrControlStyle'), newStyle = new StyleModel({ '@Name': newStyleName });
...
ko.bindingHandlers['dxStylesEditor'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        var style = ko.pureComputed(() => {
            var value = valueAccessor(), styles = value.styles && value.styles(), filtered = styles && styles.filter((item) => {
