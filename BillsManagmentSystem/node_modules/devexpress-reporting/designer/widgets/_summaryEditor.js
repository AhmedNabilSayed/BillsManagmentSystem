...
export class SummaryEditorModel extends Disposable {
    constructor(_control) {
        ...
        var ignoreNullValues = this._info.filter(info => info.propertyName === 'ignoreNullValues')[0];
    ...
    _initExpressionValues() {
        ...
        try {
            var expression = CriteriaOperatorStateMachine.parse(textBinding);
    ...
    applyChanges() {
        var undoEngine = UndoEngine.tryGetUndoEngine(this._control);
