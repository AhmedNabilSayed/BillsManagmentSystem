...
export class ExplorerEditor extends Editor {
    constructor(modelPropertyInfo, level, parentDisabled, textToSearch) {
        ...
        var model = ko.computed(() => { return this._model() && this._model()['root']; });
...
export class DrillDownEditor extends ExplorerEditor {
    constructor(info, level, parentDisabled, textToSearch) {
        ...
        this._disposables.push(ko.computed(() => {
            if (this._model() && this._model() instanceof BandViewModel) {
                var target = null;
                if (this._model() instanceof DetailBand && this._model().hasHierarchyPrintOptions()) {
                    target = this._model();
                }
                else {
                    var bands = this._model().parentModel()['bands']();
                    var position = bands.indexOf(this._model());
