...
import { imageEditOptions, imageSource, imageUrl } from '../controls/metadata/xrPicturebox';
import { pivotGridAppearances, pivotGridOptions, prefilter } from '../controls/metadata/xrPivotgrid';
import { bookmarkDuplicateSuppress, calculatedFields, drawWatermark, horizontalContentSplitting, landscape, language, margins, measureUnit, pageColor, pageHeight, pageWidth, paperKind, parametersInfo, reportExportOptionsSerializationInfo, requestParameters, rollPaper, rtlLayout, rtlReport, scriptLanguage, scriptReferencesString, showPreviewMarginLines, snapGridSize, verticalContentSplitting, watermark } from '../controls/metadata/xrReport';
...
export var groups = {
    ...
    'Appearance': {
        info: [
            ...
            viewType, watermark, formattingRuleLinks,
    ...
    'Behavior': {
        info: [
            ...
            segmentWidth, shapeFake, sizing, imageAlignment, showPreviewMarginLines, showText, startPageNumber, stretch, barcodeFake, targetDeviceDpi,
    ...
    'Data': {
        info: [
            accessibleDescription, actualValue, seriesDataMember,
            ...
            sortMode, sortOrder, summaryDisplayType,
            summaryType,
    ...
    'Navigation': {
        info: [
            bookmark, bookmarkParent, bookmarkDuplicateSuppress, target, navigateUrl
        ],
        displayName: () => getLocalization('Navigation', 'ASPxReportsStringId.DocumentViewer_RibbonNavigationGroupText')
    },
    'Page Settings': {
        info: [
            landscape, rollPaper, pageWidth, pageHeight, paperKind, margins,
        ],
