...
export class RangeParametersSettings extends ObjectItem {
    ...
    getInfo() {
        var info = super.getInfo().concat(rangeSettingsInfos);
...
export class RangeBoundaryParameter extends ObjectItem {
    ...
    getInfo() {
        if (this.valueInfo) {
            var info = $.extend(true, [], rangeBoundaryParameterInfos);
            var valueInfo = this._type() === 'System.DateTime' ? extend({}, this.valueInfo(), { editorOptions: { type: 'date' } }) : this.valueInfo();
