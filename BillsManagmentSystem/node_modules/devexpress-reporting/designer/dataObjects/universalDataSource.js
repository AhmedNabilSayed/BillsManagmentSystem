...
export class TableInfoCollectionItem extends SerializableModel {
    constructor(model, dataSource, dsHelper, serializer) {
        ...
        var options = new FilterStringOptions(this['_filterString'], ko.pureComputed(() => {
...
var tableInfoCollectionItemSerializationsInfo = [filterString, filterStringEditable, { propertyName: 'tableName', modelName: '@TableName' }];
