...
export class ObjectsStorage extends Disposable {
    ...
    findType(content) {
        var objectStorages = this.objects().filter((item) => { return item instanceof ObjectStorageItem; });
        var result = objectStorages.filter((item) => {
    ...
    createRangeSetting() {
        var rangeSettingsObject = new RangeParametersSettings({}, this.dsHelperProvider);
        this.objects.push(rangeSettingsObject);
        var startParameter = new RangeStartParameter({}, this.dsHelperProvider);
        rangeSettingsObject.startParameter(startParameter);
        this.objects.push(startParameter);
        var endParameter = new RangeEndParameter({}, this.dsHelperProvider);
