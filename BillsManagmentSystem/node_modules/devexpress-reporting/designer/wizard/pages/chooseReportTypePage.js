...
export class SelectReportTypePage extends AnalyticChooseDataSourceTypePage {
    ...
    getListOptions() {
        var searchEnabled = this._options.searchBoxVisibilityMode === SearchBoxVisibilityMode.Always ||
    ...
    initialize(state) {
        var type = state.reportType || ReportType.Standard;
        var item = findFirstItemMatchesCondition(this.typeItems, (item) => item.type === type);
