...
export class LegacyChooseReportLayoutPage extends WizardPageBase {
    constructor() {
        ...
        this.layoutTypeItems = ko.pureComputed(() => {
            var items = this._isGroupedReport() ? this._groupedReportLayoutsTypes : this._reportLayoutTypes;
    ...
    initialize(state) {
        ...
        var selectedLayoutType = getFirstItemByPropertyValue(this.layoutTypeItems(), 'layoutType', state.layout);
