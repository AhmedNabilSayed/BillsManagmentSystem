...
export class SpecifyFederationDataSourceSettingsPage extends AnalyticSpecifyFederationDataSourceSettingsPage {
    ...
    commit() {
        ...
        super.commit().done((state) => {
            var federationDataSource = _restoreFederationDataSourceFromState(state.federationDataSourceWizard, this._dataSourceWizardOptions.dataSources, state.dataSourceId);
            var infoPromise = FederationDataSourceEditor.createFederationDataSourceInfo(federationDataSource);
