...
export class SpecifySqlDataSourceSettingsPage extends SpecifyAnalyticSqlDataSourceSettingsPage {
    ...
    commit() {
        ...
        super.commit().done((commitResult) => {
            var dataSourcePromise = this['_dataSourceWizardOptions'].callbacks.createSqlDataSourceInfo(_restoreSqlDataSourceFromState(commitResult.sqlDataSourceWizard, undefined, commitResult.dataSourceId).sqlDataSource);
