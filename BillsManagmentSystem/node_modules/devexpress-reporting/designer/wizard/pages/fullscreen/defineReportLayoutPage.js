...
export class DefineReportLayoutPage extends FullscreenWizardPage {
    ...
    registerSections() {
        ...
        var meta = this._factory.getMetadata(FullscreenReportWizardSectionId.SelectDataMembersPage_Members);
        ...
        var meta = this._factory.getMetadata(FullscreenReportWizardSectionId.AddGroupFieldsPage);
        meta.description = getLocalization('Add group fields.', 'ASPxReportsStringId.ReportDesigner_Wizard_AddGroupFields');
        var meta = this._factory.getMetadata(FullscreenReportWizardSectionId.AddSummaryFieldsPage);
    ...
    _beforeStart() {
        ...
        var cachedItem = new WizardPageSection(FullscreenReportWizardSectionId.SelectDataMembersPage_Fields, $.extend(true, {}, this._sections[0].metadata, {
