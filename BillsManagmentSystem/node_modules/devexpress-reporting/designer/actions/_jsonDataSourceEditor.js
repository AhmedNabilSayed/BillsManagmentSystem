...
export class JsonDataSourceEditor extends DataSourceEditorBase {
    ...
    editSchema(dataSourceID) {
        ...
        ReportDataSourceService.jsonDataSourceFromBase64(dataSourceInfo.data['base64']())
            .done((result) => {
            var jsonDataSource = new JsonDataSource(JSON.parse(result.jsonDataSourceJSON), undefined, QBRequestWrapper());
            jsonDataSource.name(dataSourceInfo.name);
            var jsonSerialized = new ModelSerializer().serialize(jsonDataSource);
            var beforeInitEvent = (e) => {
    ...
    applyDataSourceWizardChanges(dataSourceWizardModel) {
        var jsonDataSource = _restoreJsonDataSourceFromState(dataSourceWizardModel.jsonDataSourceWizard, undefined, dataSourceWizardModel.dataSourceId);
    ...
    saveJsonSource(state, connections) {
        ...
        var jsonDataSource = _restoreJsonDataSourceFromState(jsonDataSourceState);
