...
export class ReportControlsDragDropHelper extends ObjectExplorerDragDropHelper {
    ...
    _canInsertToTarget(targetModel) {
        var targetIsContainer = targetModel.getMetaData().isContainer || targetModel instanceof ReportViewModel;
    ...
    _canDrop(target, targetModel) {
        var isReportExplorerTreeListItem = target instanceof TreeListItemViewModel && target.data && target.data['data'] instanceof ElementViewModel;
    ...
    stop() {
        ...
        var canReorder = this._canReorder(this._target, this._draggable.data), isReorderingBand = BandViewModel.isReorderingBand(this._draggableModel), isDragToBottom = this.isDragToBottom(), isBandReordering = isReorderingBand && !this._isTargetContainer;
        if (!isBandReordering) {
