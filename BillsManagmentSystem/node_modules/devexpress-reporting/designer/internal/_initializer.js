...
*/
import { getToolboxItems, initGlobalize, resolveFromPromises, SurfaceSelection } from '@devexpress/analytics-core/analytics-internal';
...
import { availableCultures } from '../../common/metadata';
...
function _createReportDesigner(element, data, callbacks, knownEnums, designerHandlerUri, previewHandlerUri, rtl, applyBindings = true) {
    var _a, _b;
    var selection = new SurfaceSelection();
    var initializer = new ReportDesignerInitializer({
    ...
    return initializer
        ...
        var state = () => initializer.reportContext() && initializer.reportContext().state() || initializer.buildingModel.state;
