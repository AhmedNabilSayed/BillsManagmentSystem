...
export class CoordinateGridViewModel extends Disposable {
    constructor(options) {
        ...
        this._disposables.push(ko.computed(() => {
            ...
            var gridSize = unitsToPixel(options.snapGridSize(), options.measureUnit(), options.zoom());
            var width = unitsToPixel(options.width(), options.measureUnit(), options.zoom());
        ...
        this._disposables.push(ko.computed(() => {
            var gridSize = unitsToPixel(options.snapGridSize(), options.measureUnit(), options.zoom());
            var height = unitsToPixel(options.height(), options.measureUnit(), options.zoom());
...
ko.bindingHandlers['coordinateGrid'] = {
    init: function (element, valueAccessor) {
        ...
        var values = valueAccessor(), gridViewModel = new CoordinateGridViewModel(values), templateHtml = getTemplate('dxrd-coordinategrid'), $element = $.fn.constructor(element).append(templateHtml);
