...
export class dxEventDropDownEditor extends dxSelectBox {
    ...
    _createEllipsisButton() {
        var $buttonIcon = $.fn.constructor('<div>').addClass(EDITOR_ELLIPSIS_BUTTON_ICON_CLASS).append(SvgTemplatesEngine.templates[EDITOR_ELLIPSIS_BUTTON_ICON_TEMPLATE]);
        ko.applyBindingsToDescendants(this._koContext, $buttonIcon[0]);
        var $button = $.fn.constructor('<div>')['dxButton']({
