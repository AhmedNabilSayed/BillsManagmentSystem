...
export class SortBySummaryInfoCondition {
    ...
    getInfo() {
        ...
        var conditionInfoClone = sortBySummaryConditionInfo.slice(0), fieldComponentName = find(sortBySummaryConditionInfo, item => item.modelName === '@FieldComponentName'), fieldComponentNameClone = $.extend(true, {}, fieldComponentName);
...
export class SortBySummaryInfo {
    ...
    getInfo() {
        ...
        var sortBySummaryInfoClone = sortBySummaryInfo.slice(0), fieldComponentName = find(sortBySummaryInfo, item => item.modelName === '@FieldComponentName'), fieldComponentNameClone = $.extend(true, {}, fieldComponentName);
    ...
    fieldsAvailableForCondition() {
        ...
        var result = [];
        fields().forEach(field => {
            var condition = find(this.conditions(), item => item.fieldComponentName() === field.name());
            if (!condition) {
