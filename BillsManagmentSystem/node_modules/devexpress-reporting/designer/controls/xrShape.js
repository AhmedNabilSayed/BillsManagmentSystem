...
export class XRShapeViewModel extends XRControlViewModel {
    constructor(model, parent, serializer) {
        ...
        this.shapeFake = {
            type: ko.pureComputed({
                ...
                write: (val) => {
                    var selectedShape = XRShapeViewModel.shapes.filter((shape) => { return shape['displayName'] === val; })[0];
    ...
    static createShape(model, serializer = null) {
        ...
        var newShape = { 'shapeType': ko.observable(type), 'getInfo': () => { return shapeInfo; } };
...
export class XRShapeControlSurface extends XRControlSurface {
    ...
    _updateImage() {
        ...
        resultDeferred.done((result) => {
            ...
            var imageSrc = (result === null || result === void 0 ? void 0 : result.imageBase64) ? 'data:image/png;base64,' + result.imageBase64 : null;
