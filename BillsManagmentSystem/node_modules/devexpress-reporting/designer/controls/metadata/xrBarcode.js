...
var calcCheckSum = { propertyName: 'calcCheckSum', modelName: '@CalcCheckSum', defaultVal: true, from: parseBool, editor: editorTemplates.getEditor('bool'), displayName: 'Calculate a Checksum', localizationId: 'DevExpress.XtraPrinting.BarCode.BarCodeGeneratorBase.CalcCheckSum' };
var code93SerializationInfo = [defaultCodeSerializationInfo, calcCheckSum];
var wideNarrowRatio = { propertyName: 'wideNarrowRatio', modelName: '@WideNarrowRatio', defaultVal: 2.5, from: floatFromModel, displayName: 'Wide Narrow Ratio', localizationId: 'DevExpress.XtraPrinting.BarCode.CodabarGenerator.WideNarrowRatio', editor: editorTemplates.getEditor('numeric') };
...
var addLeadingZero = { propertyName: 'addLeadingZero', displayName: 'Add Leading Zero', localizationId: 'DevExpress.XtraPrinting.BarCode.Code128Generator.AddLeadingZero', modelName: '@AddLeadingZero', defaultVal: false, from: parseBool, editor: editorTemplates.getEditor('bool') };
...
var fnc1Substitute = { propertyName: 'fNC1Substitute', modelName: '@FNC1Substitute', defaultVal: '#', editor: editorTemplates.getEditor('text'), displayName: 'FNC1 Functional Character', localizationId: 'DevExpress.XtraPrinting.BarCode.DataBarGenerator.FNC1Substitute' };
...
var humanReadableText = { propertyName: 'humanReadableText', modelName: '@HumanReadableText', defaultVal: true, from: parseBool, displayName: 'Human-Readable Text', localizationId: 'DevExpress.XtraPrinting.BarCode.DataMatrixGS1Generator.HumanReadableText', editor: editorTemplates.getEditor('bool') };
...
var QRCodeSerializationInfo = [
    ...
    },
    {
        ...
        modelName: '@Version', defaultVal: 'Version1', editor: editorTemplates.getEditor('combobox'), displayName: 'Version', localizationId: 'DevExpress.XtraPrinting.BarCode.QRCodeGenerator.Version',
        valuesArray: [
...
export var autoModule = { propertyName: 'autoModule', modelName: '@AutoModule', defaultVal: false, from: parseBool, editor: editorTemplates.getEditor('bool'), displayName: 'Auto-Module', localizationId: 'DevExpress.XtraReports.UI.XRBarCode.AutoModule' };
export var barCodeOrientation = {
...
export var moduleInfo = { propertyName: 'module', modelName: '@Module', defaultVal: 2, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), displayName: 'Module', localizationId: 'DevExpress.XtraReports.UI.XRBarCode.Module' };
export var showText = { propertyName: 'showText', modelName: '@ShowText', defaultVal: true, from: parseBool, editor: editorTemplates.getEditor('bool'), displayName: 'Show Text', localizationId: 'DevExpress.XtraReports.UI.XRBarCode.ShowText' };
export var symbology = { propertyName: 'symbology', modelName: 'Symbology' };
export var targetDeviceDpi = { propertyName: 'targetDeviceDpi', modelName: '@TargetDeviceDpi', displayName: 'Target Device Dpi', localizationId: 'DevExpress.XtraReports.UI.XRBarCode.TargetDeviceDpi', editor: editorTemplates.getEditor('numeric'), editorOptions: { min: 1, format: '#' } };
export var barcodeFake = { propertyName: 'barcodeFake', valuesArray: barCodesTypes, editor: designerEditorTemplates.getEditor('contentByType'), displayName: 'Symbology', localizationId: 'DevExpress.XtraReports.UI.XRBarCode.Symbology' };
...
export var barcodeSerializationsInfo = [
    alignment, autoModule, barCodeOrientation, moduleInfo, showText, symbology, text, textFormatString, keepTogether, anchorVertical, anchorHorizontal,
...
export var popularPropertiesBarCode = ['barcodeFake', 'module', 'targetDeviceDpi', 'autoModule', 'barCodeOrientation', 'text', 'popularDataBinding', 'textFormatString', 'bookmark', 'bookmarkParent', 'showText'];
