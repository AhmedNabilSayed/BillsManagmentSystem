...
export var actualValue = { propertyName: 'actualValue', defaultVal: null, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), displayName: 'Actual Value', localizationId: 'DevExpress.XtraReports.UI.XRGauge.ActualValue', modelName: '@ActualValue' };
export var maximum = { propertyName: 'maximum', defaultVal: null, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), displayName: 'Maximum', localizationId: 'DevExpress.XtraReports.UI.XRGauge.Maximum', modelName: '@Maximum' };
export var minimum = { propertyName: 'minimum', modelName: '@Minimum', defaultVal: null, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), displayName: 'Minimum', localizationId: 'DevExpress.XtraReports.UI.XRGauge.Minimum' };
export var tickmarkCount = { propertyName: 'tickmarkCount', modelName: '@TickmarkCount', defaultVal: 11, editor: editorTemplates.getEditor('numeric'), displayName: 'Tickmark Count', localizationId: 'DevExpress.XtraReports.UI.XRGauge.TickmarkCount' };
export var targetValue = { propertyName: 'targetValue', modelName: '@TargetValue', defaultVal: null, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), displayName: 'Target Value', localizationId: 'DevExpress.XtraReports.UI.XRGauge.TargetValue' };
export var viewStyle = { propertyName: 'viewStyle', modelName: '@ViewStyle', displayName: 'View Style', localizationId: 'DevExpress.XtraReports.UI.XRGauge.ViewStyle', editor: designerEditorTemplates.getEditor('viewStyle') };
export var viewTheme = {
...
export var xrGaugeSerializationInfo = [
    viewStyle, viewTheme, viewType, actualValue, tickmarkCount, maximum, minimum, targetValue, anchorVertical, anchorHorizontal, controlScripts, imageType,
...
export var popularPropertiesGauge = ['viewType', 'viewStyle', 'viewTheme', 'actualValue', 'popularDataBindingActualValue', 'targetValue', 'popularDataBindingTargetValue',
