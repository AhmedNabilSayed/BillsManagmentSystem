...
export var chart = { propertyName: 'chart', modelName: 'Chart', from: internalChart.from, toJsonObject: internalChart.toJsonObject };
export var controlParametersInfo = {
...
var chartRtl = extend(true, {}, rtl);
chartRtl.defaultVal = undefined;
export var xrChartSerializationInfo = [appearanceName, paletteName, chart, stylePriority, chartDataSource, imageType, chartScripts,
    controlParametersInfo, chartRtl,
