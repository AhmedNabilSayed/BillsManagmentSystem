...
import { autoWidth, backColor, borderColor, borderDashStyle, borderDashStyleValues, borderWidth, canPublish, foreColor, keepTogetherDefaultValueFalse, multiline, nullValueText, rtl, summary, text, textAlignment, textArea, textFormatString, xlsxFormatString } from './properties/metadata';
...
export var cellVerticalSpacing = { propertyName: 'verticalSpacing', localizable: true, modelName: '@CellVerticalSpacing', defaultVal: 0, displayName: 'Cell Vertical Spacing', localizationId: 'DevExpress.XtraReports.UI.XRCharacterComb.CellVerticalSpacing', editor: editorTemplates.getEditor('numeric') };
export var cellHorizontalSpacing = { propertyName: 'horizontalSpacing', localizable: true, modelName: '@CellHorizontalSpacing', defaultVal: 0, displayName: 'Cell Horizontal Spacing', localizationId: 'DevExpress.XtraReports.UI.XRCharacterComb.CellHorizontalSpacing', editor: editorTemplates.getEditor('numeric') };
...
var wordWrap = { propertyName: 'wordWrap', modelName: '@WordWrap', defaultVal: true, from: parseBool, displayName: 'Word Wrap', localizationId: 'DevExpress.XtraReports.UI.XRControl.WordWrap', editor: editorTemplates.getEditor('bool') };
export var characterCombFont = { propertyName: 'font', modelName: '@Font', displayName: 'Font', localizationId: 'DevExpress.XtraReports.UI.XRControl.Font', editor: designerEditorTemplates.getEditor('fontUndo') };
export var characterCombBorders = { propertyName: 'borders', modelName: '@Borders', displayName: 'Borders', localizationId: 'DevExpress.XtraReports.UI.XRControl.Borders', defaultVal: 'All', editor: editorTemplates.getEditor('borders') };
export var characterCombBorderDashStyle = $.extend({}, borderDashStyle, { valuesArray: borderDashStyleValues });
export var characterCombSerializationsInfo = [
    styleName, evenStyleName, oddStyleName, stylePriority, canPublish, backColor, autoWidth,
