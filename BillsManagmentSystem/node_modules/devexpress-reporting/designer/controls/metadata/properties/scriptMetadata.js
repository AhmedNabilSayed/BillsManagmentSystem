...
export var afterPrint = { propertyName: 'onAfterPrint', modelName: '@OnAfterPrint', displayName: 'After Print', localizationId: 'DevExpress.XtraReports.UI.XRControlEvents.OnAfterPrint', editor: designerEditorTemplates.getEditor('scriptsBox') };
export var beforePrint = { propertyName: 'onBeforePrint', modelName: '@OnBeforePrint', displayName: 'Before Print', localizationId: 'DevExpress.XtraReports.UI.XRControlEvents.OnBeforePrint', editor: designerEditorTemplates.getEditor('scriptsBox') };
export var sizeChanged = { propertyName: 'onSizeChanged', modelName: '@OnSizeChanged', displayName: 'Size Changed', localizationId: 'DevExpress.XtraReports.UI.XRControlEvents.OnSizeChanged', editor: designerEditorTemplates.getEditor('scriptsBox') };
export var evaluateBinding = { propertyName: 'onEvaluateBinding', modelName: '@OnEvaluateBinding', displayName: 'Evaluate Binding', localizationId: 'DevExpress.XtraReports.UI.XRControlEvents.OnEvaluateBinding', editor: designerEditorTemplates.getEditor('scriptsBox') };
export var truncatedControlEventsSerializationInfo = [
...
export var truncatedControlScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRPageBreak.Scripts', info: truncatedControlEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
var commonEventsSerializationInfo = truncatedControlEventsSerializationInfo.concat([sizeChanged,
...
export var commonScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRControl.Scripts', info: commonEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var controlScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRLine.Scripts', info: controlEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var textControlScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRLabel.Scripts', info: textControlEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var labelScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRLabel.Scripts', info: labelEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var chartScripts = { propertyName: 'scripts', modelName: 'Scripts', info: chartEventsSerializationInfo, displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRChart.Scripts', editor: editorTemplates.getEditor('objecteditor') };
...
export var pivotScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.Scripts', info: pivotEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
export var subreportScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.SubreportBase.Scripts', info: truncatedControlEventsSerializationInfo.concat(sizeChanged), editor: editorTemplates.getEditor('objecteditor') };
export var pdfContentScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XRPdfContent.Scripts', info: truncatedControlEventsSerializationInfo.concat(evaluateBinding), editor: editorTemplates.getEditor('objecteditor') };
var commonBandEventsSerializationInfo = [afterPrint, beforePrint];
export var commonBandScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.Band.Scripts', info: commonBandEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var groupBandScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.GroupHeaderBand.Scripts', info: groupBandEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var groupHeaderBandScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.GroupHeaderBand.Scripts', info: groupHeaderBandEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var detailReportBandScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.DetailReportBand.Scripts', info: detailReportBandEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
...
export var reportScripts = { propertyName: 'scripts', modelName: 'Scripts', displayName: 'Scripts', localizationId: 'DevExpress.XtraReports.UI.XtraReport.Scripts', info: reportEventsSerializationInfo, editor: editorTemplates.getEditor('objecteditor') };
export var allScripts = {
