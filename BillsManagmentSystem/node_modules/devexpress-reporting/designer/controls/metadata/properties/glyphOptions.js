...
var _checkStates = getEnumValues(CheckState);
var customGlyphChecked = _getCustomGlyphsInfo(_checkStates[CheckState.Checked]);
var customGlyphUnChecked = _getCustomGlyphsInfo(_checkStates[CheckState.Unchecked]);
var customGlyphIndeterminate = _getCustomGlyphsInfo(_checkStates[CheckState.Indeterminate]);
var customGlyphsSerializationInfo = [customGlyphChecked, customGlyphUnChecked, customGlyphIndeterminate];
var customGlyphs = { propertyName: 'customGlyphs', modelName: 'CustomGlyphs', info: customGlyphsSerializationInfo, displayName: 'Custom Glyphs', localizationId: 'DevExpress.XtraReports.UI.CheckBoxGlyphOptions.CustomGlyphs', editor: editorTemplates.getEditor('objecteditor') };
var style = {
    propertyName: 'style',
...
var size = { propertyName: 'size', modelName: '@Size', from: Size.fromString, defaultVal: getDefaultCheckSize().toString(), displayName: 'Size', localizationId: 'DevExpress.XtraReports.UI.CheckBoxGlyphOptions.Size', editor: editorTemplates.getEditor('objecteditor') };
export var glyphOptionsSerializationInfo = [customGlyphs, glyphAlignment, size, style];
