...
export var stylePrioritySerializationInfo = [
...
export var xlsxFormatString = { propertyName: 'xlsxFormatString', modelName: '@XlsxFormatString', defaultVal: '', editor: editorTemplates.getEditor('text'), displayName: 'Xlsx Format String', localizationId: 'DevExpress.XtraReports.UI.XRControl.XlsxFormatString' };
export var name = { propertyName: 'name', modelName: '@Name', displayName: 'Name', localizationId: 'DevExpress.XtraReports.UI.XRControl.Name', editor: designerEditorTemplates.getEditor('name'), validationRules: nameValidationRules };
export var displayName = { propertyName: 'displayNameObject', localizable: true, modelName: '@DisplayName', editor: editorTemplates.getEditor('text'), defaultVal: '', displayName: 'Display Name', localizationId: 'DevExpress.XtraReports.UI.XtraReport.DisplayName' };
export var text = { propertyName: 'text', modelName: '@Text', defaultVal: '', displayName: 'Text', localizationId: 'DevExpress.XtraReports.UI.XRControl.Text', editor: editorTemplates.getEditor('text'), localizable: true };
export var textArea = { propertyName: 'textArea', displayName: 'Text', localizationId: 'DevExpress.XtraReports.UI.XRControl.Text', defaultVal: '', localizable: true, editor: extend({}, editorTemplates.getEditor('stringArray'), { editorType: LinesEditor }) };
...
export var textTrimming = {
    propertyName: 'textTrimming', modelName: '@TextTrimming', displayName: 'Text Trimming', localizationId: 'DevExpress.XtraReports.UI.XRControl.TextTrimming', defaultVal: 'Character', editor: editorTemplates.getEditor('combobox'),
    valuesArray: textTrimmingValues
};
export var size = { propertyName: 'size', modelName: '@SizeF', from: Size.fromString, displayName: 'Size', localizationId: 'DevExpress.XtraReports.UI.XRControl.Size', editor: editorTemplates.getEditor('objecteditor'), localizable: true };
export var location = { propertyName: 'location', modelName: '@LocationFloat', from: Point.fromString, displayName: 'Location', localizationId: 'DevExpress.XtraReports.UI.XRControl.Location', editor: editorTemplates.getEditor('objecteditor'), localizable: true };
export var defaultBooleanValuesArray = [
...
export var tag = { propertyName: 'tag', modelName: '@Tag', displayName: 'Tag', localizationId: 'DevExpress.XtraReports.UI.XRControl.Tag', editor: editorTemplates.getEditor('text'), defaultVal: '' };
export var lockedInUserDesigner = { propertyName: '_lockedInUserDesigner', modelName: '@LockedInUserDesigner', defaultVal: false, from: parseBool };
export var visible = { propertyName: 'visible', modelName: '@Visible', localizable: true, defaultVal: true, from: parseBool, editor: editorTemplates.getEditor('bool'), displayName: 'Visible', localizationId: 'DevExpress.XtraReports.UI.XRControl.Visible' };
export var backColor = extend({ displayName: 'Background Color', editor: editorTemplates.getEditor('customColorEditor'), localizationId: 'DevExpress.XtraReports.UI.XRControl.BackColor' }, previewBackColor);
export var foreColor = extend({ displayName: 'Foreground Color', editor: editorTemplates.getEditor('customColorEditor'), localizationId: 'DevExpress.XtraReports.UI.XRControlStyle.ForeColor' }, previewForeColor);
export var font = extend({ displayName: 'Font', editor: editorTemplates.getEditor('font'), localizationId: 'DevExpress.XtraReports.UI.XRTableOfContentsLevelBase.Font', localizable: true }, previewFont);
export var expressionableFont = extend({}, font, { editor: designerEditorTemplates.getEditor('expressionableFont') });
export var expressionableFontInfo = [
    fontName,
    fontSize,
    fontSizeUnit,
    {
...
export var borderColor = extend({ displayName: 'Border Color', editor: editorTemplates.getEditor('customColorEditor'), localizationId: 'DevExpress.XtraReports.UI.XRControl.BorderColor' }, previewBorderColor);
export var borders = { propertyName: 'borders', modelName: '@Borders', displayName: 'Borders', localizationId: 'DevExpress.XtraReports.UI.XRControl.Borders', editor: editorTemplates.getEditor('borders') };
export var borderWidth = { propertyName: 'borderWidth', modelName: '@BorderWidth', displayName: 'Border Width', localizationId: 'DevExpress.XtraReports.UI.XRControl.BorderWidth', from: floatFromModel, editor: editorTemplates.getEditor('numeric') };
export var borderDashStyle = extend({
...
export var paddingString = { propertyName: 'padding', modelName: '@Padding' };
export var padding = { displayName: 'Padding', editor: editorTemplates.getEditor('objecteditor'), propertyName: 'paddingObj', localizationId: 'DevExpress.XtraReports.UI.XRBarCode.PaddingInfo' };
export var defaultTextPadding = '2,2,0,0,96';
export var textAlignment = extend({
...
export var angle = { propertyName: 'angle', modelName: '@Angle', defaultVal: 0, from: floatFromModel, displayName: 'Angle', localizationId: 'DevExpress.XtraReports.UI.XRLabel.Angle', editor: editorTemplates.getEditor('numeric') };
export var canGrow = { propertyName: 'canGrow', modelName: '@CanGrow', defaultVal: true, from: parseBool, displayName: 'Can Grow', localizationId: 'DevExpress.XtraReports.UI.XRControl.CanGrow', editor: editorTemplates.getEditor('bool') };
export var canShrink = { propertyName: 'canShrink', modelName: '@CanShrink', defaultVal: false, from: parseBool, displayName: 'Can Shrink', localizationId: 'DevExpress.XtraReports.UI.XRControl.CanShrink', editor: editorTemplates.getEditor('bool') };
export var multiline = { propertyName: 'multiline', modelName: '@Multiline', defaultVal: false, from: parseBool, displayName: 'Multiline', localizationId: 'DevExpress.XtraReports.UI.XRLabel.Multiline', editor: editorTemplates.getEditor('bool') };
export var wordWrap = { propertyName: 'wordWrap', modelName: '@WordWrap', defaultVal: true, from: parseBool, displayName: 'Word Wrap', localizationId: 'DevExpress.XtraReports.UI.XRControl.WordWrap', editor: editorTemplates.getEditor('bool') };
export var allowMarkupText = { propertyName: 'allowMarkupText', modelName: '@AllowMarkupText', defaultVal: false, from: parseBool, displayName: 'Allow Markup Text', localizationId: 'DevExpress.XtraReports.UI.XRLabel.AllowMarkupText', editor: editorTemplates.getEditor('bool') };
export var autoWidth = { propertyName: 'autoWidth', modelName: '@AutoWidth', defaultVal: false, from: parseBool, displayName: 'Auto Width', localizationId: 'DevExpress.XtraReports.UI.XRLabel.AutoWidth', editor: editorTemplates.getEditor('bool') };
export var keepTogether = { propertyName: 'keepTogether', modelName: '@KeepTogether', defaultVal: true, from: parseBool, displayName: 'Keep Together', localizationId: 'DevExpress.XtraReports.UI.XRControl.KeepTogether', editor: editorTemplates.getEditor('bool') };
export var keepTogetherDefaultValueFalse = { propertyName: 'keepTogether', modelName: '@KeepTogether', defaultVal: false, from: parseBool, displayName: 'Keep Together', localizationId: 'DevExpress.XtraReports.UI.XRControl.KeepTogether', editor: editorTemplates.getEditor('bool') };
export var processDuplicatesTarget = {
...
export var processDuplicatesMode = {
...
export var reportPrintOptionsSerializationInfo = [
...
export var dataAdapter = { propertyName: 'dataAdapter', modelName: '@DataAdapter', link: true, editor: null };
export var dataSource = { propertyName: 'dataSource', modelName: '@DataSource', displayName: 'Data Source', localizationId: 'DevExpress.XtraReports.UI.XtraReportBase.DataSource', link: true, editor: designerEditorTemplates.getEditor('dataSource') };
export var dataMember = { propertyName: 'dataMember', modelName: '@DataMember', displayName: 'Data Member', localizationId: 'DevExpress.XtraReports.UI.XtraReportBase.DataMember', defaultVal: '', editor: editorTemplates.getEditor('dataMember') };
export var filterString = { propertyName: '_filterString', modelName: '@FilterString' };
export var filterStringEditable = { propertyName: 'filterString', displayName: 'Filter String', localizationId: 'DevExpress.XtraReports.UI.XtraReportBase.FilterString', defaultVal: '', editor: editorTemplates.getEditor('filterEditor') };
export var bookmark = { propertyName: 'bookmark', localizable: true, modelName: '@Bookmark', displayName: 'Bookmark', localizationId: 'DevExpress.XtraReports.UI.XRControl.Bookmark', editor: editorTemplates.getEditor('text') };
export var bookmarkParent = { propertyName: 'bookmarkParent', modelName: '@BookmarkParent', link: true, displayName: 'Parent Bookmark', localizationId: 'DevExpress.XtraReports.UI.XRControl.BookmarkParent', defaultVal: null, editor: designerEditorTemplates.getEditor('reportExplorer') };
export var navigateUrl = { propertyName: 'navigateUrl', modelName: '@NavigateUrl', displayName: 'Navigation URL', localizationId: 'DevExpress.XtraReports.UI.XRControl.NavigateUrl', defaultVal: '', editor: editorTemplates.getEditor('text') };
export var target = { propertyName: 'target', modelName: '@Target', displayName: 'Navigation Target', localizationId: 'DevExpress.XtraReports.UI.XRControl.Target', editor: editorTemplates.getEditor('text'), defaultVal: '' };
export var nullValueText = { propertyName: 'nullValueText', modelName: '@NullValueText', localizable: true, displayName: 'Null Value Text', localizationId: 'DevExpress.XtraReports.UI.XRControl.NullValueText', defaultVal: '', editor: editorTemplates.getEditor('text') };
export function getSummaryFunctionValues() {
    if (DataBindingMode() === 'Bindings') {
        var values = summaryFunctionValues.concat([]);
...
export var summaryFunctionValues = [
...
export var textFormatString = { propertyName: 'textFormatString', localizable: true, modelName: '@TextFormatString', defaultVal: '', editor: designerEditorTemplates.getEditor('formatEditor'), displayName: 'Text Format String', localizationId: 'DevExpress.XtraReports.UI.XRControl.TextFormatString' };
...
export var summarySerializationInfo = createSummarySerializationInfo();
export var summary = { propertyName: 'Summary', modelName: 'Summary', info: summarySerializationInfo, editor: designerEditorTemplates.getEditor('summaryEditor'), displayName: 'Summary', localizationId: 'DevExpress.XtraReports.UI.XRLabel.Summary' };
export var reportPrintOptions = { propertyName: 'reportPrintOptions', modelName: 'ReportPrintOptions', info: reportPrintOptionsSerializationInfo, editor: editorTemplates.getEditor('objecteditor'), displayName: 'Report Print Options', localizationId: 'DevExpress.XtraReports.UI.XtraReport.ReportPrintOptions' };
export var lineWidth = { propertyName: 'lineWidth', modelName: '@LineWidth', defaultVal: 1, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), displayName: 'Line Width', localizationId: 'DevExpress.XtraReports.UI.XRLine.LineWidth' };
...
export var dpi = { propertyName: 'dpi', modelName: '@Dpi', defaultVal: 100, from: floatFromModel };
export var canPublish = { propertyName: 'canPublish', modelName: '@CanPublish', displayName: 'Can Publish', localizationId: 'DevExpress.XtraReports.UI.XRControl.CanPublish', defaultVal: true, from: parseBool, editor: editorTemplates.getEditor('bool') };
...
var rtlValuesWithInherit = rtlValues.concat([
    { value: 'Inherit', displayValue: 'Inherit', localizationId: 'DevExpress.XtraReports.UI.RightToLeft.Inherit' }
]);
export var rtl = {
    propertyName: 'rightToLeft', modelName: '@RightToLeft', displayName: 'Right To Left', localizationId: 'DevExpress.XtraReports.UI.XRControl.RightToLeft', defaultVal: 'Inherit', editor: editorTemplates.getEditor('combobox'),
...
export var paddingGroup = [paddingString, padding];
export var accessibleDescription = {
...
export var cells = { propertyName: 'cells', modelName: 'Cells', array: true };
