...
export var sortingOptionsSerializationsInfo = [targetBand, sortingFieldName];
export var interactiveSorting = { propertyName: 'interactiveSorting', modelName: 'InteractiveSorting', displayName: 'Interactive Sorting', localizationId: 'DevExpress.XtraReports.UI.XRLabel.InteractiveSorting', info: sortingOptionsSerializationsInfo, editor: editorTemplates.getEditor('objecteditor') };
