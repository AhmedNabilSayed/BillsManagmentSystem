...
export var foreColorWatermark = extend({}, foreColor, { defaultVal: 'Red' });
export var fontWatermark = extend({}, font, { defaultVal: 'Verdana, 36pt' });
var watermarkTextValues = [
...
export var watermarkSerializationsInfo = [
    fontWatermark, foreColorWatermark,
    ...
    { propertyName: 'showBehind', modelName: '@ShowBehind', defaultVal: true, from: parseBool, displayName: 'Show Behind', localizationId: 'DevExpress.XtraPrinting.Drawing.PageWatermark.ShowBehind', editor: editorTemplates.getEditor('bool') }
];
