...
var _backColor = { propertyName: '_backColor', modelName: '@BackColor', from: colorFromString, toJsonObject: colorToString };
var _foreColor = { propertyName: '_foreColor', modelName: '@ForeColor', from: colorFromString, toJsonObject: colorToString };
var _borderColor = { propertyName: '_borderColor', modelName: '@BorderColor', from: colorFromString, toJsonObject: colorToString };
export var styleSerializationInfo = [Object.assign({}, name)].concat(extend(true, [], [
...
export var styleName = { propertyName: 'styleName', modelName: '@StyleName', editor: designerEditorTemplates.getEditor('style'), displayName: 'Style', localizationId: 'DevExpress.XtraReports.UI.ConditionFormatting.Style', defaultVal: null };
export var evenStyleName = { propertyName: 'evenStyleName', modelName: '@EvenStyleName', editor: designerEditorTemplates.getEditor('style'), displayName: 'Even Style', localizationId: 'DevExpress.XtraReports.UI.XRControl.XRControlStyles.EvenStyle', defaultVal: null };
export var oddStyleName = { propertyName: 'oddStyleName', modelName: '@OddStyleName', editor: designerEditorTemplates.getEditor('style'), displayName: 'Odd Style', localizationId: 'DevExpress.XtraReports.UI.XRControl.XRControlStyles.OddStyle', defaultVal: null };
export var stylePriority = { propertyName: 'stylePriority', modelName: 'StylePriority', info: stylePrioritySerializationInfo };
...
export var pivotGridStyles = [cellStyleName, customTotalCellStyleName, fieldHeaderStyleName, fieldValueGrandTotalStyleName, fieldValueStyleName, fieldValueTotalStyleName, filterSeparatorStyleName,
    grandTotalCellStyleName, headerGroupLineStyleName, linesStyleName, totalCellStyleName];
export var crossTabStyles = [generalStyleName, headerAreaStyleName, dataAreaStyleName, totalAreaStyleName];
...
export var stylesInfo = [evenStyleName, oddStyleName, styleName].concat(pivotGridStyles, crossTabStyles);
export var stylesObj = { propertyName: 'styleObj', displayName: 'Styles', editor: editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.Styles' };
