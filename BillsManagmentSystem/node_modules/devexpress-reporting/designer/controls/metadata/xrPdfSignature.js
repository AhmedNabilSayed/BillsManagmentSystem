...
export var pdfSignatureInfo = [signatureOptions, commonScripts].concat(sizeLocation, commonControlProperties, fontGroup, navigationGroup).filter(x => x != accessibleDescription);
