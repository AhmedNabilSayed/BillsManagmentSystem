...
var linesAppearance = { propertyName: 'linesAppearance', modelName: 'Lines', displayName: 'Lines', localizationId: 'DevExpress.XtraReports.UI.PivotGrid.XRPivotGridAppearances.Lines', info: appearanceInfo, editor: editorTemplates.getEditor('objecteditor') };
export var pivotGridAppearances = { propertyName: 'appearances', modelName: 'Appearance', displayName: 'Appearance', localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.Appearance', info: appearancesInfo.concat(linesAppearance), editor: editorTemplates.getEditor('objecteditor') };
var criteriaString = { propertyName: '_criteriaString', modelName: '@CriteriaString' };
var criteriaStringEditable = { propertyName: 'criteriaString', displayName: 'Criteria', localizationId: 'DevExpress.XtraPivotGrid.Prefilter.Criteria', defaultVal: '', editor: designerEditorTemplates.getEditor('pivotCriteria') };
var enabled = { propertyName: 'enabled', modelName: '@Enabled', displayName: 'Enabled', localizationId: 'DevExpress.XtraPivotGrid.PrefilterBase.Enabled', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool };
var prefilterSerializationsInfo = [criteriaString, criteriaStringEditable, enabled];
export var prefilter = { propertyName: 'prefilter', modelName: 'Prefilter', displayName: 'Prefilter', localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.Prefilter', info: prefilterSerializationsInfo, editor: editorTemplates.getEditor('objecteditor') };
var autoTransposeChart = { propertyName: 'autoTransposeChart', modelName: '@AutoTransposeChart', displayName: 'Auto Transpose Chart', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsChartDataSource.AutoTransposeChart', defaultVal: false, editor: editorTemplates.getEditor('bool'), from: parseBool }, dataProvideMode = {
...
export var pivotGridOptions = [optionsChartDataSource, optionsDataField, optionsData, optionsPrint, optionsView];
export var pivotGridSerializationsInfo = [
