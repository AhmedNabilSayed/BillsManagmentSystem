...
export var checked = { propertyName: 'checked', modelName: '@Checked', defaultVal: false, from: parseBool, displayName: 'Checked', localizationId: 'DevExpress.XtraReports.UI.XRCheckBox.Checked', editor: editorTemplates.getEditor('bool') };
export var glyphOptions = {
...
export var checkEditOptions = $.extend({}, editOptions, {
    propertyName: 'checkEditOptions',
    from: (model, serializer) => new CheckEditOptions(model, serializer)
});
export var checkboxSerializationsInfo = [
    checkState, checked, text, textFormatString, wordWrap, keepTogether, anchorVertical, anchorHorizontal, glyphOptions,
    $.extend({}, textAlignment, { defaultVal: 'MiddleLeft' }),
    textControlScripts, textTrimming, xlsxFormatString,
...
export var popularPropertiesCheckBox = ['checkBoxState', 'popularDataBindingCheckState', 'text', 'popularDataBindingText', 'glyphOptions', 'bookmark', 'bookmarkParent'];
