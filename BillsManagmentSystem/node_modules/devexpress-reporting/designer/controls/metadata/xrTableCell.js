...
import { allowMarkupText, textTrimming } from './properties/metadata';
import { labelGroup } from './properties/metadataGroups';
import { labelScripts } from './properties/scriptMetadata';
export var weight = { propertyName: 'weight', localizable: true, modelName: '@Weight', defaultVal: 0, from: floatFromModel };
export var rowSpan = { propertyName: 'rowSpan', modelName: '@RowSpan', displayName: 'Row Span', localizationId: 'DevExpress.XtraReports.UI.XRTableCell.RowSpan', defaultVal: 1, editor: editorTemplates.getEditor('numeric') };
export var tableCellSerializationsInfo = [
    ...
    textEditOptions, allowMarkupText
].concat(createSinglePopularBindingInfos('Text'), labelGroup);
export var popularPropertiesTableCell = ['text', 'textArea', 'popularDataBinding', 'textFormatString', 'Summary', 'canGrow', 'canShrink', 'multiline', 'wordWrap'];
