...
export var rtf = { propertyName: '_rtf', defaultVal: '', displayName: 'RTF', editor: editorTemplates.getEditor('stringArray'), localizationId: 'ASPxReportsStringId.ExportName_rtf' };
export var textRtf = { propertyName: 'textRtf', defaultVal: '', displayName: 'Text', localizationId: 'DevExpress.XtraReports.UI.XRRichTextBase.RtfText', editor: editorTemplates.getEditor('stringArray') };
export var serializableRtfString = { propertyName: 'serializableRtfString', modelName: '@SerializableRtfString' };
export var newDocumentData = { propertyName: '_newDocumentData', displayName: 'Load File', localizationId: 'AnalyticsCoreStringId.UploadFile', editor: designerEditorTemplates.getEditor('richTextLoad') };
export var richTextSerializationsInfo = [
...
export var popularPropertiesRichText = ['rtf', 'popularDataBindingRtf', 'popularExpressionRtf', 'html', 'popularDataBindingHtml', 'popularExpressionHtml', '_newDocumentData', 'bookmark', 'bookmarkParent', 'canGrow', 'canShrink'];
