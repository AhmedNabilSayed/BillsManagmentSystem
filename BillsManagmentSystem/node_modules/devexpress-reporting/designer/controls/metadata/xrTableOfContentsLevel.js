...
var font = { propertyName: 'font', localizable: true, modelName: '@Font', defaultVal: 'Times New Roman, 9.75pt', displayName: 'Font', localizationId: 'DevExpress.XtraReports.UI.XRTableOfContentsLevelBase.Font', editor: editorTemplates.getEditor('font') };
var backColor = { propertyName: 'backColor', modelName: '@BackColor', defaultVal: 'Transparent', from: colorFromString, toJsonObject: colorToString, displayName: 'Background Color', localizationId: 'DevExpress.XtraReports.UI.XRControl.BackColor', editor: editorTemplates.getEditor('customColorEditor') };
var foreColor = { propertyName: 'foreColor', modelName: '@ForeColor', defaultVal: 'Black', from: colorFromString, toJsonObject: colorToString, displayName: 'Foreground Color', localizationId: 'DevExpress.XtraReports.UI.XRControl.ForeColor', editor: editorTemplates.getEditor('customColorEditor') };
export var baseTocLevelSerializationsInfo = [
    backColor,
    font,
    foreColor,
...
export var tocLevelSerializationsInfo = [
