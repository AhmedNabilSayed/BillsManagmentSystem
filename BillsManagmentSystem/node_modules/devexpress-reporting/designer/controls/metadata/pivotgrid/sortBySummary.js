...
export var field = { propertyName: 'fieldName', modelName: '@FieldName', displayName: 'Field Name', localizationId: 'DevExpress.XtraPivotGrid.PivotGridFieldSortBySummaryInfo.FieldName', defaultVal: null, editor: editorTemplates.getEditor('text') };
export var customTotalSummaryType = {
    ...
    defaultVal: '', editor: editorTemplates.getEditor('combobox'),
    valuesArray: [{ value: '', displayValue: '(none)', localizationId: 'ChartStringId.WizNoBackImage' }].concat(summaryTypeValues)
};
export var sortBySummaryInfo = [conditions, customTotalSummaryType, fieldComponentName, field, summaryType];
export var sortBySummaryConditionInfo = [
    fieldComponentName,
