...
import { availableCultures, defaultCulture } from '../../../common/metadata';
...
export var landscape = { propertyName: 'landscape', modelName: '@Landscape', displayName: 'Landscape', localizationId: 'DevExpress.XtraReports.UI.XtraReport.Landscape', defaultVal: false, from: parseBool, editor: editorTemplates.getEditor('bool') };
export var margins = { propertyName: 'margins', modelName: '@Margins', localizable: true, from: Margins.fromString, displayName: 'Margins', localizationId: 'DevExpress.XtraReports.UI.XtraReport.Margins', editor: editorTemplates.getEditor('objecteditor') };
export var pageColor = { propertyName: 'pageColor', modelName: '@PageColor', defaultVal: 'White', from: colorFromString, toJsonObject: colorToString, displayName: 'Page Color', localizationId: 'DevExpress.XtraReports.UI.XtraReport.PageColor', editor: editorTemplates.getEditor('customColorEditor') };
...
export var snapGridSize = { propertyName: 'snapGridSize', modelName: '@SnapGridSize', defaultVal: 12.5, from: floatFromModel, editor: editorTemplates.getEditor('numeric'), editorOptions: { min: 0.1 }, displayName: 'Snap Grid Size', localizationId: 'DevExpress.XtraReports.UI.XtraReport.SnapGridSize' };
export var drawWatermark = { propertyName: 'drawWatermark', modelName: '@DrawWatermark', displayName: 'Draw the Watermark', localizationId: 'DevExpress.XtraReports.UI.XtraReport.DrawWatermark', defaultVal: false, from: parseBool, editor: editorTemplates.getEditor('bool') };
export var showPreviewMarginLines = { propertyName: 'showPreviewMarginLines', modelName: '@ShowPreviewMarginLines', displayName: 'Show Margin Lines in Preview', localizationId: 'DevExpress.XtraReports.UI.XtraReport.ShowPreviewMarginLines', defaultVal: true, from: parseBool, editor: editorTemplates.getEditor('bool') };
export var verticalContentSplitting = {
...
export var reportExportOptionsSerializationInfo = { propertyName: 'exportOptions', modelName: 'ExportOptions', displayName: 'Export Options', localizationId: 'DevExpress.XtraReports.UI.XtraReport.ExportOptions', from: ExportOptions.from, toJsonObject: ExportOptions.toJson, editor: editorTemplates.getEditor('objecteditor') };
export var watermark = { propertyName: 'watermark', modelName: 'Watermark', displayName: 'Watermark', localizationId: 'DevExpress.XtraReports.UI.XtraReport.Watermark', info: watermarkSerializationsInfo, asRef: true, editor: editorTemplates.getEditor('objecteditor') };
export var rollPaper = { propertyName: 'rollPaper', modelName: '@RollPaper', displayName: 'Roll Paper', localizationId: 'DevExpress.XtraReports.UI.XtraReport.RollPaper', defaultVal: false, editor: editorTemplates.getEditor('bool'), from: parseBool };
export var requestParameters = { propertyName: 'requestParameters', modelName: '@RequestParameters', displayName: 'Request Parameters', localizationId: 'DevExpress.XtraReports.UI.XtraReport.RequestParameters', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool };
export var formattingRuleSheet = { propertyName: 'formattingRuleSheet', modelName: 'FormattingRuleSheet', displayName: 'Formatting Rule Sheet', localizationId: 'DevExpress.XtraReports.UI.XtraReport.FormattingRuleSheet', array: true };
export var pageWidth = { propertyName: 'pageWidth', modelName: '@PageWidth', displayName: 'Page Width', localizationId: 'DevExpress.XtraReports.UI.XtraReport.PageWidth', defaultVal: -1, from: floatFromModel, toJsonObject: saveAsInt, editor: editorTemplates.getEditor('numeric') };
export var pageHeight = { propertyName: 'pageHeight', modelName: '@PageHeight', displayName: 'Page Height', localizationId: 'DevExpress.XtraReports.UI.XtraReport.PageHeight', defaultVal: -1, from: floatFromModel, toJsonObject: saveAsInt, editor: editorTemplates.getEditor('numeric') };
export var localizationItems = { propertyName: '_localizationItems', modelName: 'LocalizationItems', array: true };
export var language = {
...
export var scriptReferencesString = { propertyName: 'scriptReferencesString', modelName: '@ScriptReferencesString', defaultVal: '', displayName: 'Script References', localizationId: 'DevExpress.XtraReports.UI.XtraReport.ScriptReferences', editor: editorTemplates.getEditor('stringArray') };
export var calculatedFields = {
...
export var bookmarkDuplicateSuppress = { propertyName: 'bookmarkDuplicateSuppress', modelName: '@BookmarkDuplicateSuppress', displayName: 'Bookmark Duplicate Suppress', localizationId: 'DevExpress.XtraReports.UI.XtraReport.BookmarkDuplicateSuppress', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool };
export var horizontalContentSplitting = {
...
export var rtlReport = extend({}, rtl, {
    defaultVal: 'No',
    editor: designerEditorTemplates.getEditor('reportRtlProperty'),
    valuesArray: rtlValues
});
export var reportSerializationInfo = [
...
export var popularPropertiesReport = ['dataSource', 'dataMember', 'filterString', 'measureUnit', language.propertyName];
