...
export var createSinglePopularBindingInfos = (propertyName) => {
...
export var createPopularBindingInfos = (options) => {
...
export var createPopularBindingInfo = (options, isExpression = true) => {
    var newInfo = {
