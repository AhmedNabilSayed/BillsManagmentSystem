...
export class PictureEditorToolbarItem {
    constructor(options) {
        this.id = options.id;
    ...
    constructor(options) {
        ...
        if (options.templateOptions) {
            ...
            this.templateOptions.onShown = (e) => {
                var $element = $.fn.constructor(e.element);
                var topElement = $element.position().top;
                var popupsOffset = e['model'].getPositionTarget().offset().top - $.fn.constructor(e.component.content()).offset().top;
                var $arrow = $.fn.constructor($element.find('.dx-popover-arrow')[0]);
