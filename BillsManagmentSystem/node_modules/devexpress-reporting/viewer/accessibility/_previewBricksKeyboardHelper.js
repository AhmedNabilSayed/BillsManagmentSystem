...
*/
import { AccessibilityControlElementBase, findFirstItemMatchesCondition, getLocalization, KeyboardHelperWithArrowButtonBase } from '@devexpress/analytics-core/analytics-internal';
...
export class PreviewBricksKeyboardHelper extends KeyboardHelperWithArrowButtonBase {
    ...
    _actionExecute(brick, e) {
        if (brick.navigation) {
            ...
            var efItem = findFirstItemMatchesCondition(efItems, (item) => ko.dataFor(item) === editField);
