...
export var slowdownDisctanceFactor = 2.5;
export var minScale = 0.92;
    ...
    constructor(element, slideOptions) {
        ...
        this.slideOptions.searchPanel.height.subscribe((newVal) => {
            ...
            if (this.slideOptions.readerMode) {
                ...
                this.slideOptions.topOffset(Math.min(newVal, Math.max(0, MobileSearchViewModel.maxHeight - this.firstMobilePageOffset.top)));
            }
            if (!newVal) {
    ...
    move(e) {
        ...
        if (this.slideOptions.scrollAvailable()) {
            if (direction.horizontal && this.slideOptions.swipeEnabled()) {
                var galleryInstance = Gallery.getInstance(this.$gallery.get(0));
