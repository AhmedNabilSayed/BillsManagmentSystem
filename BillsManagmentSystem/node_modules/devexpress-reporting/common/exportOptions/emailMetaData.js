...
export var nativeFormatOptionsSerializationInfo = [
    { propertyName: 'compressed', modelName: '@Compressed', displayName: 'Compressed', localizationId: 'DevExpress.XtraPrinting.PdfExportOptions.Compressed', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool },
...
export var additionalRecipients = { propertyName: 'additionalRecipients', modelName: 'AdditionalRecipients', displayName: 'Additional Recipients', localizationId: 'DevExpress.XtraPrinting.EmailOptions.AdditionalRecipients', array: true, editor: editorTemplates.getEditor('commonCollection'), addHandler: AdditionalRecipientModel.createNew, template: '#dxrd-commonCollectionItem' };
export var emailOptionsSerializationInfo = [
