...
*/
import { extend, formatDate, parseDate, processTextEditorHotKeys } from '@devexpress/analytics-core/analytics-internal';
import { getLocalization } from '@devexpress/analytics-core/analytics-utils';
import { ValueEditorHelper } from '@devexpress/analytics-core/analytics-widgets-internal';
...
export class EditingFieldExtensions {
    ...
    _registerStandartEditors() {
        var getLocalizedString = getLocalization;
        ...
        var dateEditorOptions = {
            onPreRender: (data) => {
                if (!(data.options.value() instanceof Date)) {
                    data.options.value(parseDate(data.options.value(), false) || new Date(Date.now()));
                }
            },
            onHideEditor: (field) => {
                field.editValue(formatDate(field._editorValue()));
            }
        };
