...
*/
import { getUniqueName, guid } from '@devexpress/analytics-core/analytics-internal';
...
export class TitleViewModel extends ChartElementCollectionItemBase {
    constructor(model, parent, serializer) {
        super(model, parent, serializer, titleSerializationsInfo);
        this._disposables.push(this.name = ko.pureComputed({
            read: () => { return this['text'] ? this['text']() : 'title'; },
...
export function assignTitleActions(titles) {
    var addTitle = (model) => {
        model['@Text'] = model['@Name'] = getUniqueName(titles().map(x => { return x['name'](); }), TitleViewModel.prefix);
...
var chartTitleText = { propertyName: 'text', modelName: '@Text', localizable: true, displayName: 'Text', editor: editorTemplates.getEditor('text'), localizationId: 'ASPxReportsStringId.ExportName_txt' };
export var titleSerializationsInfo = [chartTitleText, textColor, dock, titleAlignment, visibility, font18];
