...
export class StripLimitViewModel extends SerializableModel {
    constructor(model, serializer, info) {
        ...
        this.getInfo = () => {
            if (!this.enabled()) {
                var newInfo = extend(true, [], stripLimitSerializationsInfo);
                var axisValueProperty = newInfo.filter((info) => { return info.propertyName === 'axisValue'; })[0];
...
var stripLimitEnable = { propertyName: 'enabled', modelName: '@Enabled', displayName: 'Enabled', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool, localizationId: 'DevExpress.XtraCharts.StripLimit.Enabled' };
export var stripLimitSerializationsInfo = [axisValueSerializable, axisValue, stripLimitEnable, tag];
export var stripMinLimitInfo = { propertyName: 'minLimit', modelName: 'MinLimit', displayName: 'Min Limit', from: StripLimitViewModel.from, toJsonObject: StripLimitViewModel.toJson, editor: editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.Strip.MinLimit' }, stripMaxLimitInfo = { propertyName: 'maxLimit', modelName: 'MaxLimit', displayName: 'Max Limit', from: StripLimitViewModel.from, toJsonObject: StripLimitViewModel.toJson, editor: editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.Strip.MaxLimit' };
