...
export class DataContainerViewModel extends SerializableModel {
    constructor(model, serializer) {
        ...
        var array = viewBindableSerializationInfo.valuesArray;
        var actions = [];
        for (var i = 0; i < array.length; i++) {
            var value = array[i];
            var getImageClassName = (isTemplate = false) => (isTemplate ? 'dxrd-svg-fieldlist-' : 'dx-image-fieldlist-') + getSeriesClassName(value.value);
            actions.push({
...
export var dataContainerSerializationsInfo = [seriesDataMember, seriesSerializable, seriesTemplate, dataMember, pivotGridDataSourceOptions];
export var dataContainer = { propertyName: 'dataContainer', modelName: 'DataContainer', displayName: 'Data Container', info: dataContainerSerializationsInfo, from: DataContainerViewModel.from, toJsonObject: DataContainerViewModel.toJson, editor: editorTemplates.getEditor('objecteditorCustom') };
