...
export function assignIndicatorActions(indicators) {
    var addIndicator = (model, display) => {
    ...
    var actions = Object.keys(indicatorMapper).map(x => {
        var display = getLocalization(x, 'ChartStringId.Ind' + x);
        return {
            text: x,
            display: display,
    ...
    var id = 'addindicators-action_' + guid();
