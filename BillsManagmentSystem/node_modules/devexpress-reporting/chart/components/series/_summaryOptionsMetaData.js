...
export var summaryFunctionSerializationInfo = {
...
export var summaryOptionsSerializationInfoArray = [
    summaryFunctionSerializationInfo, tag
];
export var numericSummaryOptionsSerializationInfoArray = summaryOptionsSerializationInfoArray.concat([
...
export var dateTimeSummaryOptionsSerializationInfoArray = summaryOptionsSerializationInfoArray.concat([
    {
