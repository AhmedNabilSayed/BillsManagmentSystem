...
export class FillStyle extends SerializableModel {
    ...
    updateOptions(fillMode, serializer, optionsObject) {
        ...
        var optionsInfo = fillModeMapper[fillMode];
...
export var fillStyleInfo = [viewFillMode, fillStyleOptionsSerialize, tag];
export var stripFillStyle = { propertyName: 'fillStyle', modelName: 'FillStyle', displayName: 'Fill Style', localizationId: 'DevExpress.XtraCharts.Strip.FillStyle', editor: editorTemplates.getEditor('objecteditor'), from: FillStyle.from(fillStyleInfo, 'RectangleGradientFillOptions'), toJsonObject: FillStyle.toJson };
