...
import { backImage, emptyChartText, legends, paletteName, seriesSerializable, titles } from './internal/meta/_chart';
...
export class ChartControlViewModel extends Disposable {
    ...
    _getSeriesActualArgumentScaleType(argumentDataMember) {
        ...
        if (this.fieldListProvider() && argumentDataMember) {
            ...
            this.fieldListProvider().getItems(new PathRequest(seriesDataMember))
                .done((items) => {
                var result = items.filter(item => item.name === argumentFieldName)[0];
                var _scaleType = ScaleType.Numerical;
    ...
    _initSeries(series) {
        ...
        series._disposables.push(series.argumentDataMember.subscribe((newValue) => {
...
export var chartDataMember = { propertyName: 'dataMember', displayName: 'Data Member', defaultVal: '', editor: editorTemplates.getEditor('dataMemberChart'), localizationId: 'DevExpress.XtraReports.UI.XRSparkline.DataMember' };
export var chartSeriesDataMember = { propertyName: 'seriesDataMember', displayName: 'Series Data Member', defaultVal: '', editor: editorTemplates.getEditor('fieldChart'), localizationId: 'DevExpress.XtraReports.UI.XRChart.SeriesDataMember' };
export var fakeChartSerializationInfo = [
    chartDataSource, chartDataMember, chartSeriesDataMember, paletteName, seriesTemplate, seriesSerializable, diagram, titles, legend, legends, emptyChartText, backImage
];
export var chartControlSerializationsInfo = [chart];
